...
export const IndividualServicesListDetail = [
    {   
        ...
        [
            ...
            {"li":"Support in career development;"},
            {"li":"Develop your self-confidence;"},
            {"li":"Develop your assertiveness;"},
            {"li":"Improvement of one's communication with other(s)"},
            {"li":"Support in learning NO in the professional environment;"},
            {"li":"Learn to respect yourself."}
        ]
